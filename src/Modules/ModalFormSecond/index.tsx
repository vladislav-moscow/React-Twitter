  ...
  return (
    <div className="sign__modal_form">
      ...
      <form className='sign__modal_form-form' action="#" method='GET'>
        ...
        <div className="sign__modal_form-wrapper">
          <input className='sign__modal_form-input' ref={inputPassword} type="password" name='password' placeholder='Пароль' onChange={handleChange} value={inputsValue.password} />
          <span className="sign__modal_form-input-clear" id='password' onClick={handleClear}>X</span>
        </div>
        <div className="sign__modal_form-wrapper">
          <input className='sign__modal_form-input' ref={inputEmail} type="email" name='email' placeholder='Электронная почта' onChange={handleChange} value={inputsValue.email} />
